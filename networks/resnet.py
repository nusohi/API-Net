...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        load_unstrict(model, model_zoo.load_url(model_urls['resnet18']))
    return model
...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        load_unstrict(model, model_zoo.load_url(model_urls['resnet34']))
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        load_unstrict(model, model_zoo.load_url(model_urls['resnet50']))
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        load_unstrict(model, model_zoo.load_url(model_urls['resnet101']))
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        load_unstrict(model, model_zoo.load_url(model_urls['resnet152']))
        # model_path = './initmodel/resnet152_v2.pth'
        # model.load_state_dict(torch.load(model_path), strict=False)
    return model

def load_unstrict(model, state_dict):
